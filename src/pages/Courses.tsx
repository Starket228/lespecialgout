...
export default function Courses({
  ...
  return (
    <div className="pb-24">
      ...
      <div className="grid grid-cols-1 xs:grid-cols-1 sm:grid-cols-2 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-3 xs:gap-3 sm:gap-4 md:gap-5 px-3 mt-4 mx-auto w-full max-w-7xl">
